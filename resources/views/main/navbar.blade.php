...
<div class="navbar-glass navbar navbar-expand-lg px-0 px-lg-4">
  <div class="container-fluid px-lg-0">
    ...
    <ul class="list-unstyled d-flex align-items-center mb-0 gap-8">
      ...
      <li class="nav-item"><a class="nav-link {{ request()->routeIs('chatbot') ? 'active' : '' }}" href="{{ route('chatbot') }}">Chatbots</a></li>
      ...
      <li>
        ...
        @guest
            <li> <button class="btn btn-primary" onclick="window.location='{{ route('login.form') }}'">
              Se connecter
            </button></li>
        @endguest
      ...
      <div data-simplebar="" style="height: 800px">
        <div class="list-group list-group-flush">
          ...
          <a href="#" class="list-group-item list-group-item-action p-5 border-dashed border-bottom">
            <div class="d-flex justify-content-between">
              <div class="d-flex gap-4 align-items-center">
                <img src="{{ asset('admin/dasher-1.0.0/src/assets/images/avatar/avatar-2.jpg') }}" alt="" class="avatar avatar-md rounded-circle" />
                <div class="d-flex flex-column gap-1">
          ...
          <a href="#" class="list-group-item list-group-item-action p-5 border-dashed border-bottom">
            <div class="d-flex justify-content-between">
              <div class="d-flex gap-4 align-items-center">
                <img src="{{ asset('admin/dasher-1.0.0/src/assets/images/avatar/avatar-3.jpg') }}" alt="" class="avatar avatar-md rounded-circle" />
                <div class="d-flex flex-column gap-1">
