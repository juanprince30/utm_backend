...
class PublicController extends Controller
{
    ...
    public function commerce_comment(Request $request, Commerce $commerce)
    {
        ...
        // Recalcule le score (1 a 5 etoiles) du commerce via l'IA, a partir
        // de l'ensemble des commentaires. Echec silencieux si l'IA est indispo.
        app(ScoringService::class)->rescoreCommerce($commerce->id);
